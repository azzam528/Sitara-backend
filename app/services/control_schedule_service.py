...
class ControlScheduleService:
    ...
    def __init__(self):
        ...
        self.control_schedule_repository = (
            ControlScheduleRepository()
        )
    ...
    def update_schedule(
        ...
        if schedule_data.control_date is not None:
            ...
            schedule.control_date = (
                schedule_data.control_date
            )

        if schedule_data.control_time is not None:

            schedule.control_time = (
                schedule_data.control_time
            )
        ...
        if schedule_data.doctor_note is not None:
            ...
            schedule.doctor_note = (
                schedule_data.doctor_note
            )
